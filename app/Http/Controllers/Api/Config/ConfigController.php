...
class ConfigController extends Controller
{
    ...
    public function getRegisterConfig(HttpRequest $request,$type)
    {
        ...
        $showOtherRegisterMethod = getFeaturesSettings('show_other_register_method') ?? true;
        ...
        $selectRolesDuringRegistration = getFeaturesSettings('select_the_role_during_registration') ?? true;
