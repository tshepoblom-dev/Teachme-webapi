...
*/
    ...
    public function tutorlist(Request $request)
    {
        ...
        // ->where('verified', true)
         ...
         $instructors = $this->filter_Instructors($request, deepClone($query), Role::$teacher)->paginate(9);
         $categories = Category::where('parent_id', null)
             ->with('subCategories')
             ->get();
        ...
        $data['instructorsCount'] = deepClone($query)->count();

        return view(getTemplate() . '.panel.manage.tutorlist', $data);
    }
    ...
    public function tutors(Request $request)
    {
       ...
       // ->where('verified', true)
        ...
        return view(getTemplate() . '.panel.manage.tutors', $data);
    }

    private function filter_Instructors($request, $query, $role)
    {
    ...
    private function handleInstructorsOrOrganizationsPage(Request $request, $role)
    {
