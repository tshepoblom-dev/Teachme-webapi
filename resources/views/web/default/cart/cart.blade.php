...
@section('content')
    <section class="cart-banner position-relative text-center">
        <h1 class="font-30 text-white font-weight-bold">Review & Pay</h1>
        ...
        <span class="payment-hint font-20 text-white d-block"> {{ handlePrice($subTotal, true, true, false, null, true) }}</span>
    </section>
    ...
    <div class="container">
        ...
        <section class="mt-45">
            ...
            <div class="rounded-sm shadow mt-20 py-25 px-10 px-md-30">
                                    ...
                                    <div class="webinar-card-body p-0 w-100 h-100 d-flex flex-column">
                                        ...
                                        @if(!empty($cart->reserve_meeting_id))
                                            <div class="mt-10">
                                                ...
                                                <span class="text-gray font-12 border rounded-pill py-5 px-10">{{ $cart->reserveMeeting->day .' '. dateTimeFormat($cart->reserveMeeting->start_at,'h:iA',false).'-'.dateTimeFormat($cart->reserveMeeting->end_at,'h:iA',false) }}</span>
                                            </div>
                ...
                <a href="{{ url()->previous() }}" class="btn btn-sm btn-primary mt-25">Add more time</a>
        ...
        <form action="/cart/checkout" method="post" id="cartForm">
            ...
            <div class="row mt-30">
                ...
                <div class="col-12 col-lg-6">
                    <section class="mt-45">
                        <h3 class="section-title">Session Total</h3>
