            ...
            <div class="profile-info-box d-flex align-items-start justify-content-between">
                ...
                <div class="user-actions d-flex flex-column">
                   {{--
                    ...
                    <span class="bg-gray p-5 text-white" style="border-radius: 5px" >{{$user->userGroup != null ? "Rank: " . $user->userGroup->group->name : "Basic"}}</span>
{{--
...
--}}
    ...
    <div class="container mt-30">
        <section class="rounded-lg border px-10 pb-35 pt-5 position-relative bg-white">
