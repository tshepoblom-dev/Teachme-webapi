    ...
    <div class="container py-4 hero-content">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mt-4 mt-lg-0">
                <img src="{{ asset('assets/default/img/home/app.png') }}" style="height: 20rem;" alt="TeachMe App" class="img-fluid rounded shadow-lg" loading="lazy">
            </div>
        </div>
    </div>
</section>
    ...
    <section class="section my-40" id="who-we-are">
      <div class="row align-items-center">
        ...
        <div class="col-md-5 order-md-2 order-1 image-col">
          <img src="{{ asset('assets/default/img/home/teach5.png') }}" class="img-fluid about-us-img rounded" alt="About Us Image" loading="lazy">
        </div>
      </div>
    </section>
...
<div class="container-fluid container d-flex align-items-center mb-50">
    <div class="row w-100">
        ...
        <div class="col-md-6 d-md-block">
            <img src="{{ asset('assets/default/img/home/app.png')}}" class="img-fluid" alt="App Preview" style="height: 350px; " loading="lazy">
        </div>
    </div>
</div>
...
<section class="container my-65">
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 text-center mt-4 mt-lg-0">
            <img src="https://www.ospar.org/site/assets/files/1205/cooperation.629x0-is.png" alt="Why Us?" class="img-fluid rounded shadow" loading="lazy">
        </div>
    </div>
</section>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 text-center">
            ...
            <div class="contact-info">
                <p><i class="fas fa-envelope"></i> Email: <a href="mailto:info@teachmeapp.africa">info@teachmeapp.africa</a></p><br>
