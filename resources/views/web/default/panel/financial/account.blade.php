        ...
        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                @if($user->isUser())
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span class="font-16 text-gray font-weight-500">Account Balance</span>
                        </div>
                    </div>
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="/assets/default/img/activity/38.svg" width="64" height="64" alt="">
                            <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $amountSpent ? handlePrice($amountSpent) : 0 }}</strong>
                            <span class="font-16 text-gray font-weight-500">Amount Spent</span>
                        </div>
                    </div>
                @else
                    <div class="col-4 d-flex align-items-center justify-content-center">
                ...
                @can('panel_financial_payout')
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            <a href="/panel/financial/payout" class="btn btn-primary font-16 text-white font-weight-500"><span class="fa fa-arrow-down"></span>Request Payout</a>
                        </div>
                    </div>
                @endcan
