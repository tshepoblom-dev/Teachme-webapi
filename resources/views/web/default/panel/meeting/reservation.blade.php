...
@section('content')
<section>
    <h2 class="section-title" style="font-size: 18px;">{{ trans('panel.meeting_statistics') }}</h2>

    <div class="activities-container mt-15 p-10 p-lg-20" style="padding: 10px;">
        <div class="row">
            <div class="col-4 d-flex align-items-center justify-content-center">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="/assets/default/img/activity/49.svg" width="40" height="40" alt="">
                    <strong class="font-weight-bold mt-3" style="font-size: 20px;">{{ $openReserveCount }}</strong>
                    <span class="text-gray font-weight-500" style="font-size: 14px;">{{ trans('panel.open_meetings') }}</span>
                </div>
            </div>

            <div class="col-4 d-flex align-items-center justify-content-center">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="/assets/default/img/activity/50.svg" width="40" height="40" alt="">
                    <strong class="font-weight-bold mt-3" style="font-size: 20px;">{{ $totalReserveCount }}</strong>
                    <span class="text-gray font-weight-500" style="font-size: 14px;">{{ trans('panel.total_meetings') }}</span>
                </div>
            </div>

            <div class="col-4 d-flex align-items-center justify-content-center">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="/assets/default/img/activity/hours.svg" width="40" height="40" alt="">
                    <strong class="text-dark-blue font-weight-bold mt-3" style="font-size: 20px;">{{ $activeHoursCount }}</strong>
                    <span class="text-gray font-weight-500" style="font-size: 14px;">{{ trans('panel.active_hours') }}</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-8">
                                    <div class="form-group">
                                        <label class="input-label">Tutors</label>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle font-weight-500">
                                            @if(!empty($ReserveMeeting->sale) and !empty($ReserveMeeting->sale->total_amount) and $ReserveMeeting->sale->total_amount > 0)
                                                ...
                                                @if(!empty($ReserveMeeting->sale->refund_at))
                                                    (refunded)
                                                @endif
                                            @else
                                                {{ trans('public.free') }}
