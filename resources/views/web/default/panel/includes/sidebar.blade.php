   ...
   {{--<div class="user-info d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
    ...
    <div class="user-info d-flex align-items-center flex-row">
        ...
        <div class="d-flex flex-column ms-3 mx-3">
            ...
            @if(!empty($authUser->getUserGroup()))
                <span class="create-new-user text-muted font-12">{{ $authUser->getUserGroup()->name }}</span>
            @endif
        </div>
    </div>
{{--
...
--}}
    <ul id="panel-sidebar-scroll" class="sidebar-menu h-100 pt-10 @if(!empty($authUser->userGroup)) has-user-group @endif @if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])) without-bottom-image @endif" @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
        ...
        <li class="sidenav-item">
            ...
            <div class="collapse {{ (request()->is('panel/tutors') or request()->is('panel/tutors/*') or request()->is('tutorlist')) ? 'sidenav-item-active' : '' }}" id="tutorsCollapse">
                <ul class="sidenav-item-collapse">
                    <li class="mt-5 {{(request()->is('panel/tutors')) ? 'active' : '' }}">
