...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['impersonate', 'panel', 'share', 'check_maintenance', 'check_restriction', 'verified.user']], function () {
    ...
    Route::group(['prefix' => 'meetings'], function () {
        ...
        Route::match(['get', 'post'], '/{id}/finish', 'ReserveMeetingController@finish');
