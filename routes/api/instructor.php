...
use App\Http\Controllers\Panel\MeetingController;
...
//  Route::get('sales', ['uses' => 'SalesController@list']);
    Route::group(['prefix' => 'meetings'], function () {
        ...
        Route::post('/{id}/accept-request', 'ReserveMeetingController@acceptMeetingRequest');

        Route::post('/saveTime', [MeetingController::class, 'saveTime']);
        Route::post('/deleteTime', [MeetingController::class, 'deleteTime']);
        Route::get('/myMeetings', [MeetingController::class, 'myMeetingsJson']);
